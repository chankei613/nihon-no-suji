...
COLLECTORS = ["jma_rank", "jma_amedas", "jma_forecast", "jma_typhoon", "jma_warning", "jma_volcano",
              "jma_sakura", "mlit_water", "tepco_pg", "p2pquake", "enecho_gas", "boj_fx", "estat", "astro"]
...
EXPECTED_MIN = {
    ...
    # ESTAT_APP_ID を secret 登録済み（2026-09-16）。人口・完全失業率・CPI・
    # 有効求人倍率・東京転入超過数の5件が毎回返るはず。
    "estat": 5,
}
